...
export class TweetService {
  ...
  async createTweet(createTweetDto: CreateTweetDto) {
    ...
    let hashtags : Hashtag[]  = await this.hashtagService.findHashtags(createTweetDto.hashtags)
  ...
  async update(updateTweetDto: UpdateTweetDto) {
    let hastags = await this.hashtagService.findHashtags(updateTweetDto.hashtags??[]);
